...
public class SubroutineHierarchy extends JPanel {
    ...
    private void windmills(Graphics2D g2){
        ...
        g2.translate(-2.5,0.3);
        g2.scale(0.55,1.5);
        g2.setColor(new Color(100, 0, 146));
        filledTriangle(g2);
        g2.setTransform(saveTransform);
        ...
        g2.translate(-3.73,2);
        g2.scale(0.004,0.004);
        g2.rotate(Math.toRadians(frameNumber*0.75));
        g2.drawPolygon(myPolygon);
        g2.setTransform(saveTransform);

        g2.translate(-1.29,1.6);
        g2.scale(0.004,0.004);
        g2.rotate(Math.toRadians(frameNumber*0.75));
        g2.drawPolygon(myPolygon);
        g2.setTransform(saveTransform);

        g2.translate(1.55,2.05);
        g2.scale(0.003,0.003);
        g2.rotate(Math.toRadians(frameNumber*0.75));
        g2.drawPolygon(myPolygon);
        g2.setTransform(saveTransform);

        g2.translate(3.45,1.72);
        g2.scale(0.003,0.003);
        g2.rotate(Math.toRadians(frameNumber*0.75));
        g2.drawPolygon(myPolygon);
        g2.setTransform(saveTransform);

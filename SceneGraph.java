...
class SceneGraph extends JPanel {
    ...
    private void createWorld() {
        ...
        for (int i = 0; i < 7; i++)
            myPolygon.addPoint((int) (150 * Math.cos(i * 2 * Math.PI / 7)),
                    (int) (150 * Math.sin(i * 2 * Math.PI / 7)));
        ...
        r1.setRotation(-10).setTranslation(0,-0.5).setScale(3,0.2).setColor(Color.red);

        t1=new TransformedObject(filledTriangle);
        t1.setTranslation(0,-2.5).setScale(0.8,2).setColor(Color.BLUE);

        p1=new TransformedObject(outlinePolygon);
        p1.setTranslation(-1.4,-0.2).setScale(0.005,0.005);
        p2=new TransformedObject(outlinePolygon);
        p2.setTranslation(1.4,-0.7).setScale(0.005,0.005);
        ...
        r2.setTranslation(-2.5,1.8).setRotation(-10).setScale(2.5,0.15).setColor(Color.red);

        t2=new TransformedObject(filledTriangle);
        t2.setTranslation(-2.5,0.3).setScale(0.55,1.5).setColor(new Color(100, 0, 146));

        p3=new TransformedObject(outlinePolygon);
        p3.setTranslation(-3.73,2).setScale(0.004,0.004);
        p4=new TransformedObject(outlinePolygon);
        p4.setTranslation(-1.29,1.6).setScale(0.004,0.004);
